...
uint8_t devEui[] = { 0x70, 0xB3, 0xD5, 0x7E, 0xD0, 0x06, 0x98, 0x1F };      // TTN devEUI
...
/* ABP para*/
uint8_t nwkSKey[] = { 0xE0, 0x1C, 0xCD, 0xEA, 0x23, 0x79, 0xE2, 0x49, 0xE7, 0xC1, 0x02, 0xD9, 0xAF, 0xB2, 0x85, 0x70 };     // TTN NwkSKey
uint8_t appSKey[] = { 0x5A, 0xA3, 0x6C, 0xB6, 0x76, 0xB2, 0x4B, 0x09, 0xB1, 0x11, 0x11, 0x02, 0xD1, 0x9B, 0x14, 0x60 };     // TTN appSKey
uint32_t devAddr =  ( uint32_t )0x260CB596;     // TTN Device address
